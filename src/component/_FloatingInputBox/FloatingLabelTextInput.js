      ...
      <View
        ...
        {this.props.imageIcon === 'profile' ? (
          <View
            ...
            /> */}
            <Image
              source={require('../../assets/image/Profile/Edit-Fill.png')}
              style={{width: 25, height: 25, resizeMode: 'cover'}}
            />
          </View>
        ) : null}
        ...
        {this.props.imageIcon === 'company' ? (
          <View
            ...
            /> */}
            <Image
              source={require('../../assets/image/Profile/company.png')}
              style={{width: 25, height: 25, resizeMode: 'cover'}}
            />
          </View>
        ) : null}
        ...
        {this.props.imageIcon === 'pincode' ? (
          <View
            ...
            /> */}
            <Image
              source={require('../../assets/image/Profile/location.png')}
              style={{width: 25, height: 25, resizeMode: 'cover'}}
            />
          </View>
        ) : null}

        {this.props.imageIcon === 'desg' ? (
          <View
            style={{
              marginTop: 21,
              marginRight: 5,
            ...
            /> */}
            <Image
              source={require('../../assets/image/Profile/desg.png')}
              style={{width: 25, height: 25, resizeMode: 'cover'}}
            />
          </View>
        ) : null}
