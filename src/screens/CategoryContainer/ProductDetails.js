    ...
    if (
      ...
      if (productDetailsData.ack == '1') {
        this.setState({
          ...
          tone: productDetailsData.data[0].tone,
          color: productDetailsData.data[0].color,
          polish: productDetailsData.data[0].polish,
          sizeValue: productDetailsData.data[0].size,
