...
export function getWishlistData(data) {
  return dispatch => {
    ...
    axios
      ...
      .then(response => {
        if (response.data.ack === '1') {
          dispatch(onSuccess(response.data, WISHLIST_DATA_SUCCESS));
        } else {
...
export function getTotalCartCount(data) {
  return dispatch => {
    ...
    axios
      .post(urls.TotalCartCount.url, data, header)
      .then(response => {
        console.log('getTotalCartCount', response.data);
        if (response.data.ack === '1') {
          dispatch(onSuccess(response.data, TOTAL_CART_COUNT_DATA_SUCCESS));
        } else {
...
export function moveProduct(data) {
  return dispatch => {
    ...
    axios
      ...
      .then(response => {
        if (response.data.ack === '1') {
          dispatch(onSuccess(response.data, MOVE_PRODUCT_DATA_SUCCESS));
        } else {
...
export function clearAllCart(data) {
  return dispatch => {
    ...
    axios
      .post(urls.ClearCartWishlistData.url, data, header)
      .then(response => {
        console.warn('response cart clear', response.data);

        if (response.data.ack === '1') {
          dispatch(onSuccess(response.data, CLEAR_ALL_CART_DATA_SUCCESS));
        } else {
  ...
  return dispatch => {
    ...
    axios
      ...
      .then(response => {
        ...
        if (response.data.ack === '1') {
          dispatch(onSuccess(response.data, CLEAR_ALL_WISHLIST_DATA_SUCCESS));
        } else {
  ...
  return dispatch => {
    ...
    axios
      ...
      .then(response => {
        ...
        if (response.data.ack === '1') {
          dispatch(onSuccess(response.data, EDIT_CART_PRODUCT_DATA_SUCCESS));
        } else {
  ...
  return dispatch => {
    ...
    axios
      ...
      .then(response => {
        ...
        if (response.data.ack == '1') {
          dispatch(onSuccess(response.data, PLACE_ORDER_DATA_SUCCESS));
