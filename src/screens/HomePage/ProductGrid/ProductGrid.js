  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (
      ...
      newState = {
        ...newState,
        filteredTotalcountSuccessVersion:
          nextProps.filteredTotalcountSuccessVersion,
      };
    }
    if (
      filteredTotalcountErrorVersion > prevState.filteredTotalcountErrorVersion
    ) {
      newState = {
        ...newState,
        filteredTotalcountErrorVersion:
          nextProps.filteredTotalcountErrorVersion,
      };
    }
...
function mapStateToProps(state) {
  return {
    ...
    filteredTotalcountSuccessVersion:
      state.productGridReducer.filteredTotalcountSuccessVersion,
    filteredTotalcountErrorVersion:
      state.productGridReducer.filteredTotalcountErrorVersion,
  };
}
